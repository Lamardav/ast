...
//       // Имя функции (для FunctionDeclaration и FunctionExpression, null для анонимных)
...
//       while (parentPath) {
//         // Проверяем, является ли функция аргументом вызова хука
...
//           ) {
//             // Проверяем, является ли текущая функция аргументом вызова
...
//           }
//         }
//         // Проверяем, находится ли функция внутри тела хука
//         if (
